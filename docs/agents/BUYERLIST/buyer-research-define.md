---
id: buyerlist-buyer-research-define
title: Buyer Research Define Stage Prompt
description: Buyer list generation prompt for DEFINE stage
sidebar_position: 1
tags: [BUYERLIST, buyer_research, define_stage]
---

```markdown
Generate a comprehensive buyer list for M&A transaction - DEFINE STAGE

TARGET COMPANY RESEARCH:
{company_profile}

INDUSTRY RESEARCH & BUYER SEGMENTS:
{buyer_segments}
...
Generate the buyer list in the exact JSON format specified in the schema.
```